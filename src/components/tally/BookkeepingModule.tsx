...
export function BookkeepingModule({ initialTab = "day-book" }: BookkeepingModuleProps) {
  ...
  // Fetch AI insights for bookkeeping
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Day book, cash book, bank book & reconciliation</p>
        </div>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="day-book" className="mt-6">
          <DayBook />
        </TabsContent>
        ...
        <TabsContent value="bank-book" className="mt-6">
          <BankBook />
        </TabsContent>
